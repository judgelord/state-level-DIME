...
d %>% 
  ...
  geom_point(aes(x = Lower, y = reorder(state, distance_1_gov_leg_med)), shape = "L", color = "purple") + 
  geom_point(aes(x = Upper, y = reorder(state, distance_1_gov_leg_med)), shape = "U", color = "orange") + 
  labs(y = "States by Ideological Spread", x = "Mean Ideology Score", title = "Ideological Spread of Political Principals in 2004") +
  scale_x_continuous(breaks = c(-1, 0, 1)) + 
...
d %>% 
  ...
  labs(y = "States by Ideological Spread", x = "Mean Ideology Score", title = "Ideological Spread of Political Principals in 2008", color = "") +
  scale_x_continuous(breaks = c(-1, 0, 1)) + 
